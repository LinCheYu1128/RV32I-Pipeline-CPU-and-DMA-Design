...
void Vtop_SoC::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgBit(oldp+159,(((0U != (IData)(vlTOPp->top_SoC__DOT__datamem__DOT__readState)) 
                                      & (IData)(vlTOPp->top_SoC__DOT__datamem__DOT___GEN_16))));
            tracep->chgIData(oldp+160,(vlTOPp->top_SoC__DOT__datamem__DOT__memory
                                       [0U]),32);
            tracep->chgIData(oldp+161,((((IData)(vlTOPp->top_SoC__DOT__datamem__DOT__hi) 
                                         << 0x10U) 
                                        | (IData)(vlTOPp->top_SoC__DOT__datamem__DOT__lo))),32);
            tracep->chgBit(oldp+162,(((0U != (IData)(vlTOPp->top_SoC__DOT__datamem__DOT__writeState)) 
                                      & ((1U == (IData)(vlTOPp->top_SoC__DOT__datamem__DOT__writeState)) 
            ...
            tracep->chgBit(oldp+163,(((0U != (IData)(vlTOPp->top_SoC__DOT__datamem__DOT__writeState)) 
                                      & ((1U != (IData)(vlTOPp->top_SoC__DOT__datamem__DOT__writeState)) 
                                         & ((4U == (IData)(vlTOPp->top_SoC__DOT__datamem__DOT__writeState)) 
                                            & (IData)(vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0__DOT__w_determined))))));
            tracep->chgCData(oldp+164,(vlTOPp->top_SoC__DOT__datamem__DOT__writeState),3);
            tracep->chgCData(oldp+165,(vlTOPp->top_SoC__DOT__datamem__DOT__readState),2);
            tracep->chgCData(oldp+166,(vlTOPp->top_SoC__DOT__datamem__DOT__rLatencyCounter),8);
            tracep->chgCData(oldp+167,(vlTOPp->top_SoC__DOT__datamem__DOT__wLatencyCounter),8);
            tracep->chgCData(oldp+168,(((1U & (IData)(vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0__DOT__data_reg_strb))
                                         ? (0xffU & vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0__DOT__data_reg_data)
                                         : 0U)),8);
            tracep->chgCData(oldp+169,(((2U & (IData)(vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0__DOT__data_reg_strb))
                                         ? (0xffU & 
                                            (vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0__DOT__data_reg_data 
                                             >> 8U))
                                         : 0U)),8);
            tracep->chgCData(oldp+170,(((4U & (IData)(vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0__DOT__data_reg_strb))
                                         ? (0xffU & 
                                            (vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0__DOT__data_reg_data 
                                             >> 0x10U))
                                         : 0U)),8);
            tracep->chgCData(oldp+171,(((8U & (IData)(vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0__DOT__data_reg_strb))
                                         ? (0xffU & 
                                            (vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0__DOT__data_reg_data 
                                             >> 0x18U))
                                         : 0U)),8);
            tracep->chgSData(oldp+172,(vlTOPp->top_SoC__DOT__datamem__DOT__lo),16);
            tracep->chgSData(oldp+173,(vlTOPp->top_SoC__DOT__datamem__DOT__hi),16);
            tracep->chgBit(oldp+174,(((IData)(vlTOPp->top_SoC__DOT__bus__DOT__readBuses_0__DOT__outstanding) 
                                      & (IData)(vlTOPp->top_SoC__DOT__bus__DOT__readMuxes_0_io_in_0_readData_valid))));
            tracep->chgBit(oldp+175,(((0U == (IData)(vlTOPp->top_SoC__DOT__bus__DOT__readMuxes_0__DOT__state)) 
                                      | (IData)(vlTOPp->top_SoC__DOT__bus__DOT__readMuxes_0__DOT___GEN_25))));
            tracep->chgBit(oldp+176,(vlTOPp->top_SoC__DOT__bus__DOT__readBuses_0_io_slave_0_readAddr_valid));
            tracep->chgBit(oldp+177,(((IData)(vlTOPp->top_SoC__DOT__bus__DOT__readBuses_0__DOT__outstanding) 
                                      & (2U == (IData)(vlTOPp->top_SoC__DOT__cpu__DOT__mReadState)))));
            tracep->chgBit(oldp+178,(vlTOPp->top_SoC__DOT__bus__DOT__readMuxes_0_io_in_0_readData_valid));
            tracep->chgIData(oldp+179,(vlTOPp->top_SoC__DOT__bus__DOT__readMuxes_0__DOT__data_reg_data),32);
            tracep->chgBit(oldp+180,(((0U == (IData)(vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0__DOT__state)) 
                                      | (IData)(vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0__DOT___GEN_47))));
            tracep->chgBit(oldp+181,(vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0_io_slave_0_writeAddr_valid));
            tracep->chgBit(oldp+182,(vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0_io_in_0_writeData_ready));
            tracep->chgBit(oldp+183,(((IData)(vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0__DOT__aw_outstanding) 
                                      & (IData)(vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0__DOT__write_data_reg_valid))));
            tracep->chgIData(oldp+184,(((IData)(vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0__DOT__aw_outstanding)
                                         ? vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0__DOT__write_data_reg
                                         : 0U)),32);
            tracep->chgCData(oldp+185,(((IData)(vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0__DOT__aw_outstanding)
                                         ? (IData)(vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0__DOT__write_data_reg_strb)
                                         : 0U)),4);
            tracep->chgBit(oldp+186,(vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0_io_slave_0_writeResp_ready));
            tracep->chgBit(oldp+187,(vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0_io_in_0_writeResp_valid));
            tracep->chgBit(oldp+188,(vlTOPp->top_SoC__DOT__bus__DOT__readBuses_0__DOT__read_addr_reg_valid));
            tracep->chgBit(oldp+189,(vlTOPp->top_SoC__DOT__bus__DOT__readBuses_0__DOT__outstanding));
            tracep->chgBit(oldp+190,(((IData)(vlTOPp->top_SoC__DOT__bus__DOT__readBuses_0_io_slave_0_readAddr_valid) 
                                      & ((0U == (IData)(vlTOPp->top_SoC__DOT__bus__DOT__readMuxes_0__DOT__state)) 
                                         | (IData)(vlTOPp->top_SoC__DOT__bus__DOT__readMuxes_0__DOT___GEN_25)))));
            tracep->chgCData(oldp+191,(vlTOPp->top_SoC__DOT__bus__DOT__readMuxes_0__DOT__state),2);
            tracep->chgBit(oldp+192,(vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0__DOT__write_addr_reg_valid));
            tracep->chgIData(oldp+193,(vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0__DOT__write_data_reg),32);
            tracep->chgBit(oldp+194,(vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0__DOT__write_data_reg_valid));
            tracep->chgCData(oldp+195,(vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0__DOT__write_data_reg_strb),4);
            tracep->chgBit(oldp+196,(vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0__DOT__w_outstanding));
            tracep->chgBit(oldp+197,(vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0__DOT__aw_outstanding));
            tracep->chgBit(oldp+198,(vlTOPp->top_SoC__DOT__bus__DOT__writeBuses_0__DOT__b_outstanding));
            tracep->chgBit(oldp+199,(vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0__DOT__arbiter_io_in_0_valid));
            tracep->chgCData(oldp+200,(vlTOPp->top_SoC__DOT__bus__DOT__writeMuxes_0__DOT__state),2);
        }
        tracep->chgBit(oldp+201,(vlTOPp->clock));
        tracep->chgBit(oldp+202,(vlTOPp->reset));
        tracep->chgIData(oldp+203,(vlTOPp->io_regs_0),32);
        tracep->chgIData(oldp+204,(vlTOPp->io_regs_1),32);
        tracep->chgIData(oldp+205,(vlTOPp->io_regs_2),32);
        tracep->chgIData(oldp+206,(vlTOPp->io_regs_3),32);
        tracep->chgIData(oldp+207,(vlTOPp->io_regs_4),32);
        tracep->chgIData(oldp+208,(vlTOPp->io_regs_5),32);
        tracep->chgIData(oldp+209,(vlTOPp->io_regs_6),32);
        tracep->chgIData(oldp+210,(vlTOPp->io_regs_7),32);
        tracep->chgIData(oldp+211,(vlTOPp->io_regs_8),32);
        tracep->chgIData(oldp+212,(vlTOPp->io_regs_9),32);
        tracep->chgIData(oldp+213,(vlTOPp->io_regs_10),32);
        tracep->chgIData(oldp+214,(vlTOPp->io_regs_11),32);
        tracep->chgIData(oldp+215,(vlTOPp->io_regs_12),32);
        tracep->chgIData(oldp+216,(vlTOPp->io_regs_13),32);
        tracep->chgIData(oldp+217,(vlTOPp->io_regs_14),32);
        tracep->chgIData(oldp+218,(vlTOPp->io_regs_15),32);
        tracep->chgIData(oldp+219,(vlTOPp->io_regs_16),32);
        tracep->chgIData(oldp+220,(vlTOPp->io_regs_17),32);
        tracep->chgIData(oldp+221,(vlTOPp->io_regs_18),32);
        tracep->chgIData(oldp+222,(vlTOPp->io_regs_19),32);
        tracep->chgIData(oldp+223,(vlTOPp->io_regs_20),32);
        tracep->chgIData(oldp+224,(vlTOPp->io_regs_21),32);
        tracep->chgIData(oldp+225,(vlTOPp->io_regs_22),32);
        tracep->chgIData(oldp+226,(vlTOPp->io_regs_23),32);
        tracep->chgIData(oldp+227,(vlTOPp->io_regs_24),32);
        tracep->chgIData(oldp+228,(vlTOPp->io_regs_25),32);
        tracep->chgIData(oldp+229,(vlTOPp->io_regs_26),32);
        tracep->chgIData(oldp+230,(vlTOPp->io_regs_27),32);
        tracep->chgIData(oldp+231,(vlTOPp->io_regs_28),32);
        tracep->chgIData(oldp+232,(vlTOPp->io_regs_29),32);
        tracep->chgIData(oldp+233,(vlTOPp->io_regs_30),32);
        tracep->chgIData(oldp+234,(vlTOPp->io_regs_31),32);
        tracep->chgBit(oldp+235,(vlTOPp->io_Hcf));
        tracep->chgIData(oldp+236,(vlTOPp->io_inst),32);
        tracep->chgIData(oldp+237,(vlTOPp->io_rdata),32);
        tracep->chgIData(oldp+238,(vlTOPp->io_wdata),32);
        tracep->chgBit(oldp+239,(vlTOPp->io_Dump_Mem));
        tracep->chgBit(oldp+240,(vlTOPp->io_E_Branch_taken));
        tracep->chgBit(oldp+241,(vlTOPp->io_Flush));
        tracep->chgBit(oldp+242,(vlTOPp->io_Stall_MA));
        tracep->chgBit(oldp+243,(vlTOPp->io_Stall_DH));
        tracep->chgIData(oldp+244,(vlTOPp->io_IF_PC),32);
        tracep->chgIData(oldp+245,(vlTOPp->io_ID_PC),32);
        tracep->chgIData(oldp+246,(vlTOPp->io_EXE_PC),32);
        tracep->chgIData(oldp+247,(vlTOPp->io_MEM_PC),32);
        tracep->chgIData(oldp+248,(vlTOPp->io_WB_PC),32);
        tracep->chgIData(oldp+249,(vlTOPp->io_EXE_alu_out),32);
        tracep->chgIData(oldp+250,(vlTOPp->io_EXE_src1),32);
        tracep->chgIData(oldp+251,(vlTOPp->io_EXE_src2),32);
        tracep->chgIData(oldp+252,(vlTOPp->io_ALU_src1),32);
        tracep->chgIData(oldp+253,(vlTOPp->io_ALU_src2),32);
        tracep->chgIData(oldp+254,(vlTOPp->io_raddr),32);
        tracep->chgCData(oldp+255,(vlTOPp->io_WB_rd),5);
        tracep->chgIData(oldp+256,(vlTOPp->io_WB_wdata),32);
        tracep->chgBit(oldp+257,(vlTOPp->io_EXE_Jump));
        tracep->chgBit(oldp+258,(vlTOPp->io_EXE_Branch));
    }
}
